...
![image-20210429125543746](image-20210429125543746.png)
...
datafile
'/home/student/zgq/pdbtest_users02_1.dbf'
  SIZE 100M AUTOEXTEND ON NEXT 256M MAXSIZE UNLIMITED,
'/home/student/zgq//pdbtest_users02_2.dbf'
  SIZE 100M AUTOEXTEND ON NEXT 256M MAXSIZE UNLIMITED
EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
```

![image-20210429130750843](image-20210429130750843.png)

### 3.查看文件夹zgq

![image-20210429150012522](image-20210429150012522.png)

### 4.给用户new_zgq授予权限

```
-- QUOTAS
ALTER USER new_zgq QUOTA UNLIMITED ON USERS;
ALTER USER new_zgq QUOTA UNLIMITED ON USERS04;
ALTER USER new_zgq ACCOUNT UNLOCK;

-- ROLES
GRANT "CONNECT" TO new_zgq WITH ADMIN OPTION;
GRANT "RESOURCE" TO new_zgq WITH ADMIN OPTION;
ALTER USER new_zgq DEFAULT ROLE "CONNECT","RESOURCE";

-- SYSTEM PRIVILEGES
GRANT CREATE VIEW TO new_zgq WITH ADMIN OPTION;
```

![image-20210429131318857](image-20210429131318857.png)
...
![image-20210429131516971](image-20210429131516971.png)
...
![image-20210429131717662](image-20210429131717662.png)
...
![image-20210429131843821](image-20210429131843821.png)
...
![image-20210429133718560](image-20210429133718560.png)
...
![image-20210429140427550](image-20210429140427550.png)
...
![image-20210429140513813](image-20210429140513813.png)

![image-20210429140524448](image-20210429140524448.png)

![image-20210429140532793](image-20210429140532793.png)
...
![image-20210429140702017](image-20210429140702017.png)
...
![image-20210429141412322](image-20210429141412322.png)
...
![image-20210429143531717](image-20210429143531717.png)

![image-20210429143542907](image-20210429143542907.png)

![image-20210429143558383](image-20210429143558383.png)

![image-20210429143607373](image-20210429143607373.png)

![image-20210429143711183](image-20210429143711183.png)
